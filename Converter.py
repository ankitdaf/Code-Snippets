"""
These are very early attempts at writing parsers in python.

This one was probably my first program in python.

This code takes a VCF file generated by the Casio digital diaries, and converts them to readable contacts in plaintext
